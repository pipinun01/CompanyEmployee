...
namespace Service.Contracts
{
    ...
    {
        Task<(IEnumerable<ExpandoObject> employees, MetaData metada)> GetEmployeesAsync(Guid companyId, EmployeeParameters employeeParameters, bool trackChanges);
        ...
        Task SaveChangesForPatchAsync(EmployeeForUpdateDto employeeToPtch, Employee employeeEntity);
    }
}
